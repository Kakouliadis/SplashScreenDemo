...
//  SplashScreenDemo
//
//  Created by Giorgos Kakouliadis on 22/06/2018.
...
// LaunchSrceen
    private func splashSreen() {
        let launchSreenVC = UIStoryboard.init(name: "LaunchScreen", bundle: nil)
        let rootVC = launchSreenVC.instantiateViewController(withIdentifier: "splashController")
